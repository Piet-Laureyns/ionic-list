...
var HomePage = /** @class */ (function () {
    function HomePage(modalController, alertController, itemService) {
    ...
    HomePage.prototype.itemClicked = function (item) {
        var randomColorLight = this.createHexcode(Math, 'ABCDEF', 4);
        var randomColorDark = this.createHexcode(Math, '0123456789', 4);
    ...
    HomePage.prototype.searchBarChange = function () {
    };
